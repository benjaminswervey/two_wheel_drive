...
#include "interfaces/msg/detail/encoder__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Encoder *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Encoder *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Encoder__handle;
}
